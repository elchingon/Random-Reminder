...
//  remindful-base
//
//  Created by David Lowman on 12/7/10.
...
@interface PopOverView : UIView <UIWebViewDelegate> {
 ...
 */
- (void)dialogDidComplete:(PopOverView *)dialog;
 ...
 */
- (void)dialogDidNotComplete:(PopOverView *)dialog;

/**
 * Called when dialog failed to load due to an error.
 */
- (void)dialog:(PopOverView *)dialog didFailWithError:(NSError *)error;
 ...
 */
- (BOOL)dialog:(PopOverView *)dialog shouldOpenURLInExternalBrowser:(NSURL *)url;
